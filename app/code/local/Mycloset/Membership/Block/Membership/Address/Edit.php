 ...
 */
class Mycloset_Membership_Block_Membership_Address_Edit extends Mage_Directory_Block_Data
{
    protected $_address;
    ...
    public function canSetAsDefaultShipping()
    {
     ...
     public function canSetAsDefaultPickup()
    {
        if (!$this->getAddress()->getId()) {
            return $this->getCustomerAddressCount();
        }
    ...
    public function isDefaultPickup()
    {
        $defaultPickup = Mage::getSingleton('customer/session')->getCustomer()->getDefaultPickup();
        return $this->getAddress()->getId() && $this->getAddress()->getId() == $defaultPickup;
    }
